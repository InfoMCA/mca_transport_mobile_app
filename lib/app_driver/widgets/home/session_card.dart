    ...
    return GestureDetector(
      onTap: () async {
        SessionObject session =
            await SessionObject.getFromLocalStorage(widget.session.id);
        if (session == null) {
          ...
          Expanded(
              ...
              child: Column(
                ...
                children: [
                  SizedBox(height: 4),
                  Text(
                    widget.session.sessionStatus.getName() +
                        ": " +
      ...
      child: Column(
        children: [
          ...
          Container(
            ...
            child: TextButton(
              onPressed: () =>
                  MapsLauncher.launchQuery(widget.session.source.toString()),
          ...
          Container(
            ...
            child: TextButton(
              onPressed: () => MapsLauncher.launchQuery(
                  widget.session.destination.toString()),
              child: SingleChildScrollView(
                scrollDirection: Axis.horizontal,
                child: Row(
                  mainAxisAlignment: MainAxisAlignment.start,
