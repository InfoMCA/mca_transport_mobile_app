            ...
            TextButton(
                ...
                child: Row(
                  children: [
                    Text(
                      "Save",
                      style: TextStyle(color: AppColors.portGore, fontFamily: 'poppins', fontSize: 14, fontWeight: FontWeight.w700),
                    ),
                    Icon(
                      Icons.save,
        ...
        Container(
            ...
            child: Center(
              child: Text(
                ...
                style: TextStyle(color: Colors.black, fontFamily: 'poppins', fontSize: 16, fontWeight: FontWeight.w700),
              ),
            )),
    ];
  }
