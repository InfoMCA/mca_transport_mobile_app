...
import 'package:transportation_mobile_app/views/report/panels/pictures_grid.dart';
import 'package:transportation_mobile_app/views/report/panels/signature.dart';
...
class _InspectionMainPageState extends State<InspectionMainPage>
  ...
  Map<ReportTabs, List<ReportCategories>> tabCategories = {
    ReportTabs.PickUp:
    [ReportCategories.PickupPictures, ReportCategories.PickupSignature],
    ReportTabs.DropOff:
    [ReportCategories.DropOffPictures, ReportCategories.DropOffSignature],
  };
  ...
  void initState() {
    super.initState();
    ReportCategories.values.forEach((element) {_panelExpanded[element] = false;});
    setState(() {
    ...
    return DefaultTabController(
      ...
      child: Scaffold(
        ...
        body: Container(
          color: Colors.white,
          child: TabBarView(
              children: tabCategories.entries.map((e) =>
                          ...
                          children: <Widget>[
                            ExpansionPanelList(
                              ...
                              expansionCallback: (int index, bool isExpanded) {
                                setState(() {
                                  ReportCategories.values.forEach((element) { _panelExpanded[element] = false;});
                                  _panelExpanded[_getByPanelIndex(tabIndex, index)] = !isExpanded;
                                });
                              },
                                ...
                                children: categories.map((e) =>
                                  ExpansionPanel(
                                      ...
                                      headerBuilder:
                                        ...
                                        return ListTile(
                                            title: Text(e.getTitle(), style: TextStyle(
                                                color: Colors.black,
                                                fontFamily: 'poppins',
                                                fontWeight: FontWeight.w700),));
                                      },
                                      ...
                                      isExpanded: _panelExpanded[e])).toList(),
                        ),
                            Container(
                              height: 80,
                              child: Row(
                                ...
                                children: [
                                  ...
                                  if (tabIndex.canUserEditTab(getCurrentSession().sessionStatus))
                                    Center(
                                      child: TextButton(
                                        onPressed: () async {
                                          getCurrentSession()
  ...
  List<String> _getMissingPicture(List<ReportCategories> reportCategories) {
    ...
    ReportCategories signatureCategory = reportCategories
        .where((element) => element.getTitle() == 'Signature').first;
